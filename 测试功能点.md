...
| # | 测试点 | 测试内容 | Qwen 3.5 | Kimi K2.5 | GLM-5 | Minimax 2.1 | Minimax 2.5 | 优先级 |
|---|--------|---------|----------|-----------|-------|-------------|-------------|--------|
| L1 | 超长上下文（脚本验证） | 使用 `tests/test_long_context.py` 独立脚本执行超长上下文 create/stream 探测，观察 `reasoning_content`、`content`、最终可用性与边界行为 | ⏳ | ⏳ | ⏳ | ⏳ | ⏳ | P1 |
